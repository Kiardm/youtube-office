    ...
    return (
      <div className="yt-office-shell yt-office-shell--compact">
        <div className="yt-office-compact-bar">
          <div>
            <div className="yt-office-compact-title"><span className="yt-office-live-light" data-connected={connected} />YouTube Office 4.2.2</div>
          ...
          <button
            ...
            aria-label="Minimize YouTube Office 4.2.2"
            title="Minimize"
    ...
    <aside className={`yt-office-panel${controlCenterOpen ? ' yt-office-panel--control-open' : ''}`}>
      <header style={{ position: 'sticky', top: 0, zIndex: 2, padding: 16, background: '#171321', borderBottom: '2px solid #4a4058', WebkitAppRegion: 'drag' } as React.CSSProperties}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
          <div><div className="yt-office-title">YouTube Office 4.2.2</div><div className="yt-office-connection" data-connected={desktopConnected}><span className="yt-office-live-light" data-connected={desktopConnected} />{connectionLabel}</div></div>
