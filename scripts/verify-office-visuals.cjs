...
async function main() {
  ...
  try {
    ...
    const result = {
      ok: compactCheck.title === 'YouTube Office 4.2.2'
        && compactCheck.minimize
        && compactCheck.canvas
        && expandedCheck.title === 'YouTube Office 4.2.2'
